...
const MeasurerHistory = () => {
  ...
  const closedRequests = requests.filter((r) => ["measurement_done", "closed", "cancelled"].includes(r.status));
        ...
        {loading ? (
          ...
          <Card className="bg-white border-slate-200">
            <CardContent className="py-16 flex flex-col items-center justify-center text-center">
              ...
              <p className="text-slate-500 text-sm">Нет завершённых замеров</p>
            </CardContent>
          </Card>
        ) : (
